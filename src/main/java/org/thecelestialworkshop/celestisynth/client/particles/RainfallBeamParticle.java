...
public class RainfallBeamParticle extends SimpleAnimatedParticle {
    ...
    public RainfallBeamParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, SpriteSet pSprites) {
    ...
    public static class Quasar extends RainfallBeamParticle {
        ...
        public Quasar(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, SpriteSet pSprites) {
