...
public class RainfallEnergyParticle extends SimpleAnimatedParticle {
    ...
    public RainfallEnergyParticle(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, SpriteSet pSprites) {
    ...
    public static class Small extends RainfallEnergyParticle {
        ...
        public Small(ClientLevel pLevel, double pX, double pY, double pZ, double pXSpeed, double pYSpeed, double pZSpeed, SpriteSet pSprites) {
