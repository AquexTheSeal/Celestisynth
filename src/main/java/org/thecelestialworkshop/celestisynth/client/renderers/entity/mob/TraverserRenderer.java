...
public class TraverserRenderer extends GeoEntityRenderer<Traverser> {
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, Traverser animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
