...
public class MoveToTargetGoal extends Goal {
    ...
    public MoveToTargetGoal(PathfinderMob pMob, double pSpeedModifier, boolean pFollowingTargetEvenIfNotSeen, double reach) {
        this.mob = pMob;
        this.reach = reach;
        ...
        if (i - this.lastCanUseCheck < 20L) {
            ...
            if (livingentity == null) {
                ...
                if (this.path != null) {
                    ...
                    return reach >= this.mob.distanceToSqr(livingentity.getX(), livingentity.getY(), livingentity.getZ());
                }
            }
        }
    }
