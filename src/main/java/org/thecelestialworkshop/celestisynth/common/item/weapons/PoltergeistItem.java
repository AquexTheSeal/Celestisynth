...
import org.thecelestialworkshop.celestisynth.common.item.base.SkilledAxeItem;
...
public class PoltergeistItem extends SkilledAxeItem implements CSGeoItem {
    ...
    public String texture(ItemStack stack) {
        if (attackExtras(stack).getBoolean(PoltergeistCosmicSteelAttack.IS_IMPACT_LARGE)) {
