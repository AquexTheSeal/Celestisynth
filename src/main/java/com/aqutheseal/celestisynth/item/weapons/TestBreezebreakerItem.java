...
public class TestBreezebreakerItem extends SkilledSwordItem {
    ...
    public TestBreezebreakerItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
