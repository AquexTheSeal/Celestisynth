...
public class SetAnimationServerPacket {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> CSNetwork.sendToPlayersNearbyAndSelf(new SetAnimationToAllPacket(isOtherLayer, context.getSender().getId(), this.animId), context.getSender()));
        return true;
    }
}