...
public class CSVisualTypes {
    ...
    public static final RegistryObject<CSVisualType> BREEZEBREAKER_WHEEL = addVisual(new CSVisualType("breezebreaker_wheel", CSVisualModel.FLAT_VERTICAL_FRONTFACE, CSVisualAnimation.noAnimWithLifespan(12), 6, 2, 4, false, false, false));
    public static final RegistryObject<CSVisualType> BREEZEBREAKER_WHEEL_IMPACT = addVisual(new CSVisualType("breezebreaker_wheel_impact", CSVisualModel.FLAT_VERTICAL_SIDEFACE, CSVisualAnimation.noAnimWithLifespan(12), 6, 2, 2, false, false, true));
    ...
    public static final RegistryObject<CSVisualType> BREEZEBREAKER_DASH_2 = addVisual(new CSVisualType("breezebreaker_dash_2", CSVisualModel.FLAT_VERTICAL_SIDEFACE, CSVisualAnimation.noAnimWithLifespan(15), 0, 0, 4, false, true, false));
    public static final RegistryObject<CSVisualType> BREEZEBREAKER_DASH_3 = addVisual(new CSVisualType("breezebreaker_dash_3", "breezebreaker_dash_2", CSVisualModel.FLAT_VERTICAL_SIDEFACE, CSVisualAnimation.noAnimWithLifespan(10), 0, 0, 2, false, true, false));

    public static final RegistryObject<CSVisualType> POLTERGEIST_WARD = addVisual(new CSVisualType("poltergeist_ward", CSVisualModel.FLAT_VERTICAL_SIDEFACE, CSVisualAnimation.GOO, 0, 0, 1.2, false, false, false));
    ...
    public static final RegistryObject<CSVisualType> POLTERGEIST_RETREAT = addVisual(new CSVisualType("poltergeist_retreat", CSVisualModel.FLAT_VERTICAL_SIDEFACE, CSVisualAnimation.noAnimWithLifespan(15), 0, 0, 2.25, false, true, false));
    ...
    public static final RegistryObject<CSVisualType> AQUAFLORA_PIERCE_START = addVisual(new CSVisualType("aquaflora_pierce_start", CSVisualModel.FLAT_VERTICAL_SIDEFACE, CSVisualAnimation.noAnimWithLifespan(12), 6, 2, 1.5, false, false, true));
    public static final RegistryObject<CSVisualType> AQUAFLORA_STAB = addVisual(new CSVisualType("aquaflora_stab", CSVisualModel.FLAT_VERTICAL_FRONTFACE, CSVisualAnimation.noAnimWithLifespan(4), 4, 1, 1.2, false, false, true));
    ...
    public static final RegistryObject<CSVisualType> AQUAFLORA_BASH = addVisual(new CSVisualType("aquaflora_bash", CSVisualModel.FLAT_VERTICAL_SIDEFACE, CSVisualAnimation.noAnimWithLifespan(12),  6, 2, 1.75, false, true, false));
    ...
    public static final RegistryObject<CSVisualType> RAINFALL_SHOOT = addVisual(new CSVisualType("rainfall_shoot", CSVisualModel.FLAT_VERTICAL_SIDEFACE, CSVisualAnimation.noAnimWithLifespan(16), 8, 2, 2.25, false, false, true));
    public static final RegistryObject<CSVisualType> RAINFALL_VANISH = addVisual(new CSVisualType("rainfall_vanish", CSVisualModel.FLAT_VERTICAL_SIDEFACE, CSVisualAnimation.noAnimWithLifespan(20), 0, 0, 2.25, false, true, false));
