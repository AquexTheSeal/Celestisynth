...
public class CSItems {
    ...
    public static final RegistryObject<Item> POLTERGEIST = ITEMS.register("poltergeist", () -> new PoltergeistItem(Tiers.NETHERITE, 10 - 4, -3.1F, (new Item.Properties()).fireResistant().rarity(CSRarityTypes.CELESTIAL)));
