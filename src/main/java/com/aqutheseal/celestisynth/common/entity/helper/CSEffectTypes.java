...
public enum CSEffectTypes implements IExtensibleEnum {
    ...
    CSEffectTypes(String name, String texture, Model model, Animation animation, SoundEvent effectSound, int frames, int framesSpeed, double scale, boolean rotateRandomly, boolean fadeOut, boolean specialProperties) {
        this.name = name;
    ...
    CSEffectTypes(String name, String texture, Model model, Animation animation, int frames, int framesSpeed, double scale, boolean rotateRandomly, boolean fadeOut, boolean specialProperties) {
        this(texture, texture, model, animation, SoundEvents.END_GATEWAY_SPAWN, frames, framesSpeed, scale, rotateRandomly, fadeOut, specialProperties);
    }
