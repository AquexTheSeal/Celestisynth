...
public class CSVisualModel {
    ...
    public static CSVisualModel FLAT_VERTICAL_FRONTFACE = new CSVisualModel("cs_effect_flat_vertical");
    public static CSVisualModel FLAT_VERTICAL_SIDEFACE = new CSVisualModel("cs_effect_flat_vertical_side");
