...
public enum CSArmorMaterials implements ArmorMaterial {
    SOLAR_CRYSTAL("solar_crystal", 29, Util.make(new EnumMap<>(ArmorItem.Type.class), (map) -> {
        map.put(ArmorItem.Type.BOOTS, 3);
        map.put(ArmorItem.Type.LEGGINGS, 6);
        map.put(ArmorItem.Type.CHESTPLATE, 8);
        map.put(ArmorItem.Type.HELMET, 3);
    }), 10, SoundEvents.ARMOR_EQUIP_GOLD, 1.7F, 0.0F, () -> Ingredient.of(CSBlocks.SOLAR_CRYSTAL.get()));
