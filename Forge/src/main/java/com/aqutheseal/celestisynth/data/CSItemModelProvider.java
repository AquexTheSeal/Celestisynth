...
public class CSItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        this.defaultItem(CSItems.ITEM.getEntries());

        this.csSinglePredicatedModel(CSItems.SOLARIS, "item/long_blade", csLoc("soul"), "item/long_blade");
        this.csCustomModel(CSItems.CRESCENTIA, getCSLoc("item/long_blade"));
        this.csCustomModel(CSItems.BREEZEBREAKER, getCSLoc("item/long_blade"));
