...
As of 1.3.2's release, Celestisynth 2.x (the major rewrite, CelestisynthDX) is in the works. As per the changelog,
we will be focusing on the 2.x rewrite going forward. The only exception to this is if a bug renders the mod completely 
unplayable or something of a similar scale happens.

The repository will be made public under our organization (The Celestial Workshop) once the first release is ready. Thank 
you for sticking with us in the meantime!